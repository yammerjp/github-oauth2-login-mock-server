...
export OAUTH_REDIRECT_URI=http://localhost:8080/hello
...
curl --verbose "${GITHUB_LOGIN_SERVER}/login/oauth/authorize/?client_id=${OAUTH_CLIENT_ID}&redirect_uri=${OAUTH_REDIRECT_URI}&state=this-is-a-random-state"
